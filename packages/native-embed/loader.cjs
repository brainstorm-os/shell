/**
 * CJS entry for `@brainstorm/native-embed` (plan 11.3).
 *
 * Sits in front of the auto-generated `./index.js` to wire packaged-mode binary
 * resolution, exactly like `@brainstorm/native`'s loader. In dev it's a
...
// napi-rs-generated loader (incl. `@brainstorm/native`, `@napi-rs/keyring`). If
